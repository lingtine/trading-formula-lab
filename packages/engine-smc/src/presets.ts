...
export const PRESETS: PresetDef[] = [
  ...
  {
    id: 'btc_h1_h4_safe',
    name: 'BTC Futures H1/H4 – An toàn',
    description: 'Bias H4, vào lệnh H1. Ít tín hiệu nhưng chắc hơn M15.',
    timeframe: 'H1',
    params: {
      htfTimeframe: 'H4',
      requireHTFBias: true,
      swingLen: 5,
      structureLookback: 350,
      bosBreakMode: 'close',
      chochSensitivity: 'strict',
      eqToleranceValue: 0.18,
      eqMinTouches: 2,
      ...
      displacementMin: 1.5,
      bodyRatioMin: 0.6,
      requireDisplacementForOB: true,
      obRangeMode: 'full',
      obLookback: 250,
      obFreshMaxTouches: 1,
      fvgMinSize: 0.1,
      fvgFreshMaxFillRatio: 0.45,
      minConfluenceCount: 3,
      conflictPolicy: 'no_trade',
      minRR: 2.2,
    },
  ...
  {
    id: 'btc_h4_ultra_safe',
    name: 'BTC Futures H4 – Siêu an toàn',
    description: 'Chỉ trade theo H4. Ít kèo, phù hợp swing/position.',
    timeframe: 'H4',
    params: {
